...
# AI Image Generation Skill (v25)

> **Skill ID**: `ai-image-generation` v25
> **Worker Endpoint**: `https://ai-image.lishuhang.workers.dev` (已部署 v25 worker)
> **Upstream**: `https://grok.17nas.com/local-api`（必须经 worker 代理，直连会被 Cloudflare 拦截）
> **Source Reference**: `worker_v25.js` (2087 行，已部署)
...
- Worker 源码：`worker_v25.js`（v25，2087 行）
- Skill 规范：`v25-ai-image-skill.md`（本文档）
- Skill 实现：`ai_image_skill.py`（v25，约 760 行）
