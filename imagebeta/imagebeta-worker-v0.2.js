// Cloudflare Worker - AI生图 Beta v0.2 (imagebeta-worker)
// v0.2: 修复 v0.1 遗留的水印面板 HTML 残片；首个可上线 beta 版本 — 上游 keydraw.97api.com（V2EX 帖 https://www.v2ex.com/t/1222012 自荐站），
...
async function handleProxy(request, url) {
  ...
  // v0.1: keydraw uses Authorization: Bearer, not Cookie
  if (st) headers.set('Authorization', 'Bearer ' + st);
