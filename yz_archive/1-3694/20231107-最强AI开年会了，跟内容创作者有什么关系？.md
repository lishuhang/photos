# 最强AI开年会了，跟内容创作者有什么关系？
> 公众号: 娱乐资本论
> 发布时间: 2023年11月07日 14:21
> 原文链接: https://mp.weixin.qq.com/s/hjEa_FxCnEcP4-QjFSGjOg
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUaDAmibqg8qvFckcRk3AjIQZEQ3uF9XzKIpaE6tt3gPH2gWLOFO6q8Tyg/640?wx_fmt=png&from=appmsg)速记原文

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUaotsCZhdvORo8lLg0S7V1jncRdXKpRxbibRKlZXn475SI7F26PYSUHAA/640?wx_fmt=png&from=appmsg)GPT-4 Turbo API调用的速记整理结果

换用ChatGPT，我们把速记全文贴进去，7000多字的文本也没有让它抱怨“太长”，开始在后台吭哧吭哧地整理了。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUa45icfHaI1pOmKwtU0LljB8CZQg1ADGSmqChVpWYF0EMY582icBzaMnLw/640?wx_fmt=png&from=appmsg)在主prompt之后暂停，并贴入全文
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUacNibNvgbpXbRmUsvDFdicpmm40K5FnRLA1BnvibUsS7yUomy15Vs66ibXQ/640?wx_fmt=png&from=appmsg)

理论上，这可以大大增加ChatGPT的可玩性，比如很多人期待的图生图功能，有的玩法很成功：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUa7IIz6x3IRDRAM963icnYrs0uNK9o5MIYBd8JMBwDBCqpvpbO8mTBMDw/640?wx_fmt=png&from=appmsg)

但也不是每次尝试都让人满意。比如，我安排的一个任务是，看他能不能识别一张新闻照片，并更改照片的画风。这个任务需要同时调用原本分开的识图、搜索和生图能力。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUadtDWj431rVicRrJFAdIszjAU7vObXVw9c6LyBzGYV6zlK2EeDh8SwCg/640?wx_fmt=png&from=appmsg)（生成结果为英文，经过浏览器自带工具翻译）

我们发现ChatGPT经过这次更新之后，多模态或联网功能有时会输出英文结果，即使用中文提问。好在这不算是什么大问题，浏览器自带翻译的质量也不差。

问题在于，识图的时候，ChatGPT不能一同联网，也没有以图搜图去寻找准确答案。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUaTGyNaOZBJtnibUOJIicIRR5DlCBEGwHSibxIQZOtpo9J5nNHiaArym9XhA/640?wx_fmt=png&from=appmsg)（生成结果为英文，经过浏览器自带工具翻译）

在联网的时候，ChatGPT运用了上一步生成的图片描述文字，因此只能不结合图像来猜测（当然他还是猜对了）。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUarYcPVBqzM3jzGANIHyR5gTALm3ETd8XeQzIdpJaTODPQ6KDMC949Jg/640?wx_fmt=png&from=appmsg)（生成结果为英文，经过浏览器自带工具翻译）
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUarnn0zwHyibbJU0Ezamd0JKibPov0UCUWJaPXztKdK3ayXyfRgh3rYZYg/640?wx_fmt=png&from=appmsg)

这是过去大半年来我们经常能在各处看到的景象。

目前已经通过国家备案的近20款大模型都有过类似的表述，说通过C-Eval、mmLU和AGIEval等测试集，它们在性能的某个角度或全局，都超越了GPT-3.5甚至GPT-4。

但是，用户实际上手使用的体验却是另一回事。根据娱乐资本论·视智未来9月份进行的[第二次国产大模型实用场景测评](https://mp.weixin.qq.com/s?__biz=MzkyODM5MzMxMA==&mid=2247489633&idx=1&sn=887b916ab8909244de828776916f7ef3&scene=21#wechat_redirect)，GPT-4在绝大多数问题上都会比国产友商们高1-2分（问题满分5分），假如其联网能力正常工作，恐怕分数还会更高。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUag4r8iazh1n2kgapQuyb3qh40yvHKDFP472ib9fdXURKylumib5nISmF9A/640?wx_fmt=png&from=appmsg)

此后，[ChatGPT又推出多模态能力的重大升级](https://mp.weixin.qq.com/s?__biz=MzkyODM5MzMxMA==&mid=2247490286&idx=1&sn=acc764bc0d51f4987ae8610a15614e4b&scene=21#wechat_redirect)。跟这个版本的ChatGPT相比，国产模型们的差距被拉得更大了。今天开发者大会后更新的ChatGPT，在性能的多数方面跟上次升级时一致。但如同上文所说，支持“300页图书”的长输入，将让它进一步挤占以此为卖点的大模型的生存空间，比如Claude、百川、月之暗面、零一万物等。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUajyKZFLrlXNCm88Q7vMmQ1RFIFKvRPpeOEW4XPgjj0zJLowg5WjjltA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUatGufYh5hk6wb0oLBthlE84nL5e9tYBkaFSYL6ETdLIibs2MLFH3Gs6w/640?wx_fmt=png&from=appmsg)

新的“GPT”创建能力没有马上推出，而是要等到11月底。OpenAI方面放出了一些官方预置的“GPT”，我们尝试了其中一个“GenZ 4 meme”，它的长项是用拽拽的语气回答你对于欧美年轻人流行文化的疑问。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUavrBGJk17SXvwBJ3MhWUD6zEKYUfSKzkOHGgpSYqZkiaqQs3vdyfCnvg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/D5Zgib0agBaAOZia7K6Zh0zpyceyHxlmUa2ialyN0mEcH5hcLJOIaX4UNEn71YnicExmiaHC6WzTeUI6AhFMm97Czicg/640?wx_fmt=png&from=appmsg)
