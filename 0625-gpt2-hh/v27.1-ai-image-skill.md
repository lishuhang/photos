...
# AI Image Generation Skill (v27.1)

> **Skill ID**: `ai-image-generation` v27.1
> **Worker Endpoint**: `https://ai-image.lishuhang.workers.dev` (已部署 v27.1 worker)
> **Upstream**: `https://grok.17nas.com/local-api`（必须经 worker 代理，直连会被 Cloudflare 拦截）
> **Source Reference**: `worker_v27.1.js` (2671 行，已部署)
...
- Worker 源码：`worker_v27.1.js`（v27.1，2671 行）
- Skill 规范：`v27.1-ai-image-skill.md`（本文档）
- Skill 实现：`ai_image_skill_v27.1.py`（v27.1，约 760 行）
